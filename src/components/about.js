...
const About = () => {
    ...
    return (
        <div className="about_div">
            <div style={{ "backgroundColor": "var(--blue)", }} className="nice_border">
                <h1>Who are you?</h1>
                <p>
            ...
            <div style={{ "backgroundColor": "var(--green)", }} className="nice_border">
                <h1>Interests</h1>
                <p>
            ...
            <div style={{ "backgroundColor": "var(--pink)", }} id="random" className="nice_border">
                <h1>Random</h1>
                <div className='random-div'>
                    <div style={{ textAlign: 'center', }}>
                        <img src={profile} width="460" className='normal-img' id="profile" style={{ verticalAlign: "middle", borderRadius: "24px", padding: '12px', }} alt="" />
                    </div>
                    <div>
                        <p>
